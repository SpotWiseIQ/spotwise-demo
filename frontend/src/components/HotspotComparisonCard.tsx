    ...
    <div className="bg-white rounded-lg shadow border border-gray-200 w-[170px] flex-shrink-0 flex flex-col h-[330px]">
      <div className="p-2 border-b border-gray-200 h-[50px]">
        <div className="flex items-center mb-1">
          <div className={`hotspot-card ${hotspot.trafficLevel?.toLowerCase()} !h-4 !w-4 !text-xs !flex !items-center !justify-center mr-2`}>
            {hotspot.label}
          </div>
          <h3 className="text-xs font-medium truncate">{hotspot.name}</h3>
        </div>
        <p className="text-[10px] text-gray-500 truncate">{hotspot.address || 'No address'}</p>
      </div>
      
      <div className="p-2 flex-grow flex flex-col">
        <div className="grid grid-cols-2 gap-2 text-[10px] py-2 border-b border-gray-100 h-[60px]">
          <div className="flex flex-col items-center">
            <p className="text-gray-500 mb-0.5">Traffic</p>
            <p className="font-medium capitalize">{hotspot.trafficLevel}</p>
          </div>
          <div className="flex flex-col items-center">
            <p className="text-gray-500 mb-0.5">Area Type</p>
            <p className="font-medium text-center max-w-full overflow-hidden text-ellipsis">
              {hotspot.areaType || 'Commercial'}
            </p>
          </div>
        </div>
        ...
        <div className="flex-grow flex flex-col">
          <div className="flex items-center py-2 border-b border-gray-100 h-[40px]">
            <div className="w-3 h-3 mr-1 flex-shrink-0">
              <Footprints className="w-3 h-3 text-tampere-red" />
            </div>
          ...
          <div className="flex items-center py-2 border-b border-gray-100 h-[40px]">
            <div className="w-3 h-3 mr-1 flex-shrink-0">
              <Building className="w-3 h-3 text-tampere-red" />
            </div>
            <p className="text-[10px]">
